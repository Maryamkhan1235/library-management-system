...
cout<<"                             ****************************************************             "<<endl;
cout<<"                             *                                                  *             "<<endl;
cout<<"                             *        WELCOME TO LIBRARY MANAGAMENT SYSTEM      *             "<<endl;
cout<<"                             *                                                  *             "<<endl;
cout<<"                             ****************************************************             "<<endl;
...
system(" cls");
    ...
    books[22]= {23, "The Curious Incident of the Dog in the Night-Time", "Mark Haddon", 2003, false};
    books[23]= {24, "Before We Were Strangers", "Renee Carlino", 2015, false};
    books[24]= {25, "The Boy in the Striped Pajamas", "John Boyne", 2006, false};
    books[25]= {26, "The House on Mango Street", "Sandra Cisneros", 1984, false};
    books[26]= {27, "Love, Stargirl", "Jerry Spinelli", 2007, false};
...

{
    ...
    for (int i = 0; i < bookCount; i++)
	 ...
	 {
        if (books[i].year <= 1980 && books[i].year > 1950) 
		
		{ // Example range for children's books
            cout << MAGENTA "ID: " << books[i].id << "\n";
    ...
    for (int i = 0; i < bookCount; i++)
	 ...
	 {
        if (books[i].year > 1980 && books[i].year <= 2000) 
		
		{ // Example range for middle grade
            cout << MAGENTA "ID: " << books[i].id << "\n";
    ...
    for (int i = 0; i < bookCount; i++)
	 ...
	 {
        if (books[i].year > 2000 && books[i].year <= 2015) 
        
		{ // Example range for young adult
            cout << MAGENTA "ID: " << books[i].id << "\n";
            
            cout << YELLOW "Title: " << books[i].title << "\ n";
    ...
    for (int i = 0; i < bookCount; i++)
	 ...
	 {
        if (books[i].year > 1925)
		
		 { // Example range for modern fiction
            cout << MAGENTA "ID: " << books[i].id << "\n";
